sap.ui.define([
	...
	return Controller.extend("ba.eventmanager-openui5.controller.Overview", {
		...
		onCreateEvent: function () {
			...
			// var dateFormatR = sap.ui.core.format.DateFormat.getDateTimeInstance({
			// 	pattern: "dd.MM.yyyy"
			// });
			// var date = oView.byId("dateInput").getValue();
			// if (date) {
			// 	date = dateFormatR.format(new Date(date));
			// }
	...
	var date = oView.byId("dateInput").getValue();
			...
			/*
			var categoryKey = oView.byId("inputCategory").getSelectedItem().getKey();
			var categoryName = oView.byId("inputCategory").getSelectedItem().getText();
			console.log(categoryKey);
			var supplier = oView.byId("inputSupplier").getSelectedItem().getKey();
			var supplierName = oView.byId("inputSupplier").getSelectedItem().getText();
			console.log(supplier);*/

			oModel.setData({"Events":  [{
